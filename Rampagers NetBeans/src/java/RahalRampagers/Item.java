...
public class Item {
  ...
  public void addItem() throws Exception {
    ...
    String queryString = "insert into Item (iName,category,auctionStart,auctionEnd,startPrice,description,photo,sellerID,currentBid,status,winnerID) values(?,?,NOW(),?,?,?,?,?,0,0,0)";
